...
<body>
    ...
    <div class="modal fade" id="ModalPKTK" tabindex="-1" aria-labelledby="modalPKTKLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <!-- Modal body -->
                                <form action="#" method="post" enctype="multipart/form-data" onsubmit="return validateFormKiemTraKho();">
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label for="NKT">Ngày kiểm tra</label>
                                        <input type="date" name="NKT" id="NKT" class="form-control" aria-describedby="NKT-mess" value="<?php echo date('Y-m-d'); ?>">
                                        <small id="NKT-mess"></small>
                                    </div>

                                    <div class="form-group">
                                        <label for="TTKT">Trạng thái kiểm tra</label>
                                        <input type="text" name="TTKT" id="TTKT" class="form-control" aria-describedby="TTKT-mess" onblur="test('#TTKT', ktTTKT)">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="MSPQLK" id="MSPQLK" class="form-control" aria-describedby="MSPQLK-mess" onblur="test('#MSPQLK', ktMSPQLK)">
                ...
                <form action="#" method="post" enctype="multipart/form-data" onsubmit="return validateFormSP();">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="HSD" id="HSD" class="form-control" aria-describedby="HSD-messs" value="<?php echo date('Y-m-d'); ?>">
                                    ...
                                    <form action="#" method="post" enctype="multipart/form-data" onsubmit="return validateFormNhapKho();">
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="NLPNK" id="NLPNK" class="form-control" placeholder="vi du: 20/11/2023" aria-describedby="NLPNK-mess"value="<?php echo date('Y-m-d'); ?>">
            ...
            <div class="modal fade" id="ModalPXK" tabindex="-1" aria-labelledby="modalPXKLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <input type="date" name="NLPXK" id="NLPXK" class="form-control" placeholder="vi du: 20/11/2023" aria-describedby="NLPXK-mess" value="<?php echo date('Y-m-d'); ?>">
                                    ...
                                    <label for="">Mã Sản Phẩm</label>
                                        <input type="text" name="MSPX" id="MSPX" class="form-control"
                                            placeholder="" aria-describedby="MSPX-messs"
                                            onblur="test('#MSPX', ktMSPX)">
