...
class MCart
{
    function getAllProduct()
    {
        ...
        $con = null;
        if ($p->connect_DB($con)) {
            $str = 'SELECT sp.TenSanPham,sp.HinhAnh, sp.GiaBan, gh.SoLuong, gh.MaGioHang FROM giohang gh JOIN sanpham sp ON gh.MaSanPham = sp.MaSanPham WHERE gh.MaKhachHang = "03";';
